    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#f6f3ff] to-[#fff0f5] py-8 px-2 md:px-12">
        ...
        <div className="flex flex-col lg:flex-row gap-8 justify-center">
          ...
          <div className="flex-1 max-w-3xl">
            <div className="bg-white rounded-2xl shadow-xl p-5">
              <h2 className="text-lg font-bold text-violet-500 mb-3">Overall Rankings</h2>
              ...
              {/* <div>
                {rankings.map((item) => (
                  <div
                    ...
                    <div className="w-12 flex items-center justify-center">
                      <span className="text-gray-400 text-lg font-semibold">{item.rank}</span>
                      <span className="ml-2 text-xl hidden md:inline" title={item.iconLabel}></span>
                    </div>
                    ...
                    <div className="">
                      <div className="font-bold text-violet-600 text-lg">{item.points}</div>
                    ...
                    <div className="ml-4">
                      {item.badge && (
                        <span className={`px-3 py-1 rounded-full text-xs font-bold ${item.badgeColor}`}>{item.badge}</span>
                      )}
                    </div>
                  </div>
                ))}
