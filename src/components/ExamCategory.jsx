  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row min-h-screen p-10 bg-[#e0e0e04b] font-GentiumBookPlus">
        ...
        {/* Sidebar */}
        <aside
          className={`bg-white shadow-lg w-full lg:w-80 lg:block z-20 transition-all duration-300 ${sidebarOpen ? "block" : "hidden lg:block"
            }`}
        >
          ...
          <ul>
            {examCategories.map((cat) => (
              <li
                ...
                className={`flex items-start gap-3 px-6 py-4 cursor-pointer transition ${selected === cat.id
